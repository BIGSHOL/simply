...
description: Backend specialist for FastAPI, AI API integration, and business logic. Use proactively for backend tasks.
...
pytest tests/api/test_tests.py -v
# Expected: FAILED (아직 구현 없음)

# 2. 구현 코드 작성
# - app/api/v1/tests.py
# - app/services/test_service.py 등
...
# 4. GREEN 상태로 커밋
git add .
git commit -m "feat: T1.3 테스트 목록 API 구현 (GREEN)"
```
